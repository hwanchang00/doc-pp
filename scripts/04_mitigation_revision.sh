...
REVISION_SCRIPT="$REPO_ROOT/src/04_mitigation_revision_provider_fixed.py"
JUDGE_SCRIPT="$REPO_ROOT/src/04_mitigation_revision_judge.py"
...
REVISION_CONFIGS=(
    "data/03_final_data.json|mitigation_revision_image_indirect_with_policy_qwen3-vl-235b_instruct.json|indirect|-|-|qwen/qwen3-vl-235b-a22b-instruct|-|image|120|144|4|false"
    "data/03_final_data.json|mitigation_revision_image_indirect_with_policy_mistral-large_instruct.json|indirect|-|-|mistralai/mistral-large-2512|-|image|120|144|4|false"
)

echo "============================================"
echo "Stage 1: Running Revision Evaluation"
echo "============================================"

for config in "${REVISION_CONFIGS[@]}"; do
    ...
    echo "Running: $PYTHON_BIN $REVISION_SCRIPT $ARGS"
    "$PYTHON_BIN" "$REVISION_SCRIPT" $ARGS
done

# ============================================
# Stage 2: Judge Evaluation (using revised_response)
# ============================================
# Format: INPUT_FILE|OUTPUT_FILE|JUDGE_MODEL|BATCH_SIZE

JUDGE_CONFIGS=(
    "results/mitigation_revision_image_indirect_with_policy_qwen3-vl-235b_instruct.json|judge_mitigation_revision_image_indirect_with_policy_qwen3-vl-235b_instruct.json|openai/gpt-5-mini|4"
    "results/mitigation_revision_image_indirect_with_policy_mistral-large_instruct.json|judge_mitigation_revision_image_indirect_with_policy_mistral-large_instruct.json|openai/gpt-5-mini|4"
)
